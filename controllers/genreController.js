...
exports.genre_create_get = (req, res)=>{
    res.render('./genre_view/genre_form', { title: 'Create Genre' });
}
...
exports.genre_create_post = [
    ...
    (req, res, next) => {
      ...
      if (!errors.isEmpty()) {
        ...
        res.render('./genre_view/genre_form', { title: 'Create Genre', genre: genre, errors: errors.array()});
        return;
      }
      else {
...
exports.genre_delete_get = function(req, res) {
    async.parallel({
      ...
      // Successful, so render.
      res.render('./genre_view/genre_delete', { title: 'Delete Genre', genre: results.genre, books: results.books } );
  });
};
